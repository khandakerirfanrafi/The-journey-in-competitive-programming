...
void deleteAtanyPos(Node* &head,int idx){//deleting the node at head
...
void sort_link_list(Node* &head){//sorting the linked list
...
int main()
{
    ...
    //deleteAtanyPos(head,2);//deleting the node at head
